...
- [css-color](https://github.com/ap/vim-css-color) (syntax, autoload)
...
- [javascript](https://github.com/pangloss/vim-javascript) (syntax, indent, compiler, ftdetect, ftplugin)
